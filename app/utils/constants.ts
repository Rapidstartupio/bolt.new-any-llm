...
const PROVIDER_LIST: ProviderInfo[] = [
...

  {
    ...
    staticModels: [
      ...
      { name: 'o1', label: 'O1', provider: 'OpenAI', maxTokenAllowed: 100000 },
      { name: 'o1-mini', label: 'o1-mini', provider: 'OpenAI', maxTokenAllowed: 64000 },
      { name: 'o1-preview', label: 'O1 Preview', provider: 'OpenAI', maxTokenAllowed: 32000 },
      { name: 'gpt-4o-realtime-preview', label: 'GPT-4o Realtime Preview', provider: 'OpenAI', maxTokenAllowed: 4000 },
    ],
